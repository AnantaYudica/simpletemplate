...
#ifndef MASTER_TYPEHELPER_PARAMETER_EXPAND_VARIABLE_H_
#define MASTER_TYPEHELPER_PARAMETER_EXPAND_VARIABLE_H_
...
#endif /* MASTER_TYPEHELPER_PARAMETER_EXPAND_VARIABLE_H_ */
