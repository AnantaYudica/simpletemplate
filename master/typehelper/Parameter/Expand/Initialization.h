...
#ifndef MASTER_TYPEHELPER_PARAMETER_EXPAND_INITIALIZATION_H_
#define MASTER_TYPEHELPER_PARAMETER_EXPAND_INITIALIZATION_H_
...
#endif /* MASTER_TYPEHELPER_PARAMETER_EXPAND_INITIALIZATION_H_ */
