...
#ifndef MASTER_TYPEHELPER_PARAMETER_VALUES_EXPAND_RESULT_H_
#define MASTER_TYPEHELPER_PARAMETER_VALUES_EXPAND_RESULT_H_
...
#endif /* MASTER_TYPEHELPER_PARAMETER_VALUES_EXPAND_RESULT_H_ */
